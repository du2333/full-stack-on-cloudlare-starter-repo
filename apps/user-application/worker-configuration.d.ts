/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env --env stage` (hash: c365c282d2700af23c338dd9896e3248)
...
declare namespace Cloudflare {
	interface Env {
		...
		STRIPE_PRODUCT_ENTERPRICE: string;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_BASE_HOST" | "CLOUDFLARE_ENV" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "STRIPE_PRODUCT_BASIC" | "STRIPE_PRODUCT_PRO" | "STRIPE_PRODUCT_ENTERPRICE">> {}
}
